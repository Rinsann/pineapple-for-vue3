<template>
  <div class="pineapple-tabs">
    <div class="pineapple-tabs-nav" ref="container">
      <div
        class="pineapple-tabs-nav-item"
      ...
      <div class="pineapple-tabs-nav-indicator" ref="indicator"></div>
    </div>
    <div class="pineapple-tabs-content">
